...
ALARM_SOUND_FREQ = 2500  # Frequency of alarm sound (Hz)
ALARM_SOUND_DURATION = 1000  # Duration of alarm sound (milliseconds)
...
def sound_alarm_continuous():
    """Play alarm sound continuously until eyes open"""
    global alarm_flag
    alarm_flag = True
